...
public class PostcardResponse {
  ...
  **/
  ...
  private PostcardDetailsReturned details;
  /**
  * Get details
  * @return details
  **/
  ...
  public PostcardDetailsReturned getDetails() {
      return details;
  }
  ...
  **/
  ...
  /*
  public PostcardResponse id(String id) {
  ...
  */
  ...
  /*
  public PostcardResponse description(String description) {
  ...
  */
  ...
  /*
  public PostcardResponse from(Object from) {
  ...
  */
  ...
  /*
  public PostcardResponse resourceType(ResourceTypeEnum resourceType) {
  ...
  */
  ...
  /*
  public PostcardResponse details(PostcardDetailsReturned details) {
  ...
  */
  ...
  public void setDetails(PostcardDetailsReturned details) {
    this.details = details;
  }
  ...
  /*
  public PostcardResponse metadata(Map<String, String> metadata) {
  ...
  */
  ...
  public PostcardResponse putMetadataItem(String key, String metadataItem) {
    if (this.metadata == null) {
      this.metadata = new HashMap<String,String>();
    }
  ...
  /*
  public PostcardResponse templatePreviewUrls(Object templatePreviewUrls) {
  ...
  */
  ...
  /*
  public PostcardResponse templatePreviews(List<Object> templatePreviews) {
  ...
  */
  ...
  public PostcardResponse addTemplatePreviewsItem(Object templatePreviewsItem) {
  ...
  /*
  public PostcardResponse deleted(Boolean deleted) {
  ...
  */
  ...
  /*
  public PostcardResponse campaigns(List<Campaign> campaigns) {
  ...
  */
  ...
  public PostcardResponse addCampaignsItem(Campaign campaignsItem) {
  ...
  /*
  public PostcardResponse dateCreated(OffsetDateTime dateCreated) {
  ...
  */
  ...
  /*
  public PostcardResponse dateModified(OffsetDateTime dateModified) {
  ...
  */
  ...
  /*
  public PostcardResponse _object(ObjectEnum _object) {
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    PostcardResponse postcardResponse = (PostcardResponse) o;
    return Objects.equals(this.id, postcardResponse.id) &&
        Objects.equals(this.description, postcardResponse.description) &&
        Objects.equals(this.from, postcardResponse.from) &&
        Objects.equals(this.resourceType, postcardResponse.resourceType) &&
        Objects.equals(this.details, postcardResponse.details) &&
        Objects.equals(this.metadata, postcardResponse.metadata) &&
        Objects.equals(this.templatePreviewUrls, postcardResponse.templatePreviewUrls) &&
        Objects.equals(this.templatePreviews, postcardResponse.templatePreviews) &&
        Objects.equals(this.deleted, postcardResponse.deleted) &&
        Objects.equals(this.campaigns, postcardResponse.campaigns) &&
        Objects.equals(this.dateCreated, postcardResponse.dateCreated) &&
        Objects.equals(this.dateModified, postcardResponse.dateModified) &&
        Objects.equals(this._object, postcardResponse._object);
  }
