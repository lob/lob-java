...
public class Upload {
  ...
  */
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, accountId, campaignId, columnMapping, mode, failuresUrl, originalFilename, state, totalMailpieces, failedMailpieces, validatedMailpieces, bytesProcessed, dateCreated, dateModified);
  }
