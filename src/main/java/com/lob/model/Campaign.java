...
public class Campaign {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "An internal description that identifies this resource. Must be no longer than 255 characters. ")
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "Account ID that this campaign is associated with.")
