...
public class ChecksApi {
     ...
     */
    public okhttp3.Call checksListCall(Integer limit, String before, String after, List<String> include, Map<String, String> dateCreated, Map<String, String> metadata, Boolean scheduled, MailType mailType, SortBy5 sortBy, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call checksListValidateBeforeCall(Integer limit, String before, String after, List<String> include, Map<String, String> dateCreated, Map<String, String> metadata, Boolean scheduled, MailType mailType, SortBy5 sortBy, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = checksListCall(limit, before, after, include, dateCreated, metadata, scheduled, mailType, sortBy, _callback);
        return localVarCall;
     ...
     */
    public CheckList checksList(Integer limit, String before, String after, List<String> include, Map<String, String> dateCreated, Map<String, String> metadata, Boolean scheduled, MailType mailType, SortBy5 sortBy) throws ApiException {
        try {
            ApiResponse<CheckList> localVarResp = checksListWithHttpInfo(limit, before, after, include, dateCreated, metadata, scheduled, mailType, sortBy);
            return localVarResp.getData();
        } catch (ApiException e) {
            throw e;
        }
     ...
     */
    public ApiResponse<CheckList> checksListWithHttpInfo(Integer limit, String before, String after, List<String> include, Map<String, String> dateCreated, Map<String, String> metadata, Boolean scheduled, MailType mailType, SortBy5 sortBy) throws ApiException {
        try {
            okhttp3.Call localVarCall = checksListValidateBeforeCall(limit, before, after, include, dateCreated, metadata, scheduled, mailType, sortBy, null);
     ...
     */
    public okhttp3.Call checksListAsync(Integer limit, String before, String after, List<String> include, Map<String, String> dateCreated, Map<String, String> metadata, Boolean scheduled, MailType mailType, SortBy5 sortBy, final ApiCallback<CheckList> _callback) throws ApiException {

        okhttp3.Call localVarCall = checksListValidateBeforeCall(limit, before, after, include, dateCreated, metadata, scheduled, mailType, sortBy, _callback);
        Type localVarReturnType = new TypeToken<CheckList>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
