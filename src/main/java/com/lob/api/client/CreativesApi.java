...
public class CreativesApi {
    ...
    public CreativeResponse create(CreativeWritable creativeWritable, String xLangOutput) throws ApiException {
        try {
            ApiResponse<CreativeResponse> localVarResp = createWithHttpInfo(creativeWritable, xLangOutput);
     ...
     */
    public ApiResponse<CreativeResponse> createWithHttpInfo(CreativeWritable creativeWritable, String xLangOutput) throws ApiException {
        try {
     ...
     */
    public okhttp3.Call createAsync(CreativeWritable creativeWritable, String xLangOutput, final ApiCallback<CreativeResponse> _callback) throws ApiException {
    ...
    public CreativeResponse get(String crvId) throws ApiException {
        try {
            ApiResponse<CreativeResponse> localVarResp = getWithHttpInfo(crvId);
            return localVarResp.getData();
        } catch (ApiException e) {
            throw e;
        }
     ...
     */
    public ApiResponse<CreativeResponse> getWithHttpInfo(String crvId) throws ApiException {
        try {
     ...
     */
    public okhttp3.Call getAsync(String crvId, final ApiCallback<CreativeResponse> _callback) throws ApiException {
    ...
    public CreativeResponse update(String crvId, CreativePatch creativePatch) throws ApiException {
        try {
            ApiResponse<CreativeResponse> localVarResp = updateWithHttpInfo(crvId, creativePatch);
            return localVarResp.getData();
        } catch (ApiException e) {
            throw e;
        }
     ...
     */
    public ApiResponse<CreativeResponse> updateWithHttpInfo(String crvId, CreativePatch creativePatch) throws ApiException {
        try {
     ...
     */
    public okhttp3.Call updateAsync(String crvId, CreativePatch creativePatch, final ApiCallback<CreativeResponse> _callback) throws ApiException {
