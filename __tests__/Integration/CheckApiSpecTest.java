...
public class CheckApiSpecTest {
    ...
    {
        validApi = new ChecksApi(Configuration.getConfigForIntegration());
    ...
    public void bankAccountGetTest() throws ApiException {
        ...
        Check response = validApi.get("chk_ce509f2983b63c3f");

        Assert.assertNotNull(response);
        Assert.assertNotNull(response.getId());
        Assert.assertEquals(response.getId(), "chk_ce509f2983b63c3f");
        // createdBankAccounts.add(response);
    }
