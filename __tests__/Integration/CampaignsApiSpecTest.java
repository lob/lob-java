...
public class CampaignsApiSpecTest {
    ...
    public void createCampaignTest() throws ApiException {
        ...
        cmpWritable.setName("Java Integration Test Campaign A"+ OffsetDateTime.now());
    ...
    public void campaignRetrieveTest() throws ApiException {
        CampaignWritable cmpWritable = new CampaignWritable();
        cmpWritable.setName("Java Integration Test Campaign B" + OffsetDateTime.now());
        cmpWritable.setScheduleType(CmpScheduleType.IMMEDIATE);
    ...
    public void CampaignUpdateTest() throws ApiException {
        CampaignWritable cmpWritable = new CampaignWritable();
        cmpWritable.setName("Java Integration Test Campaign C"+ OffsetDateTime.now());
        cmpWritable.setScheduleType(CmpScheduleType.IMMEDIATE);
        ...
        update.setDescription("Java Integration Test Updated Campaign"+ OffsetDateTime.now());
    ...
    public void campaignDeleteTest() throws ApiException {
        CampaignWritable cmpWritable = new CampaignWritable();
        cmpWritable.setName("Java Integration Test Campaign D"+ OffsetDateTime.now());
        cmpWritable.setScheduleType(CmpScheduleType.IMMEDIATE);
    ...
    public void before_list_test()
    {
        validApi = new CampaignsApi(Configuration.getConfigForIntegration());
        CampaignWritable cmpWritable = new CampaignWritable();
        cmpWritable.setName("Java Integration Test Campaign E"+ OffsetDateTime.now());
        cmpWritable.setScheduleType(CmpScheduleType.IMMEDIATE);
        ...
        cmpWritable.setName("Java Integration Test Campaign F"+ OffsetDateTime.now());
        try {
        ...
        cmpWritable.setName("Java Integration Test Campaign G"+ OffsetDateTime.now());
        try {
